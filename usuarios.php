...
<a href="usuario_cadastrar.php" class="btn btn-primary">Criar Um novo Usuário</a>
...
<?php if($qt > 0){ ?>
    ...
    <tbody>
        <?php while($usuario = mysqli_fetch_assoc($result)){ ?>
            ...
            <td><?=$usuario["login"]?></td>
            <td>
                <a href="usuario_editar.php?id=<?= $usuario['id'] ?>" class="btn btn-warning" title="Editar usuário">
